...
import contactForm from "./1FAIpQLSffdjeHqtd13tYhSRDoStvm8wqZpzB3yek6niGbrg-mMaNTbw.json" with { type: "json" };
...
const registry = new Map<string, FormDefinition>([
  ...
  [
    "1FAIpQLSffdjeHqtd13tYhSRDoStvm8wqZpzB3yek6niGbrg-mMaNTbw",
    contactForm as FormDefinition,
  ],
]);
